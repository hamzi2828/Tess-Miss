                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-shrink-0 dropdown-notifications-actions">
                      @if(is_null($notification->read_at))
                        ...
                        <a href="{{ route('notifications.read', $notification->id) }}" class="dropdown-notifications-read">
                          <span class="badge badge-dot bg-primary"></span>
                          unread
                        </a>
                      @endif
                      <a href="{{ route('notifications.read', $notification->id) }}" class="dropdown-notifications-archive">
